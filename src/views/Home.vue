        ...
        <section class="hero is-dark">
            <div class="hero-body">
                <div class="container has-text-centered">
                    ...
                    <hr>
                    <h2 class="subtitle"><font-awesome-icon icon="check" /> TypeScript + class-based component syntax</h2>
                    <h2 class="subtitle"><font-awesome-icon icon="check" /> UI styled with Bulma CSS + SASS + Font Awesome 5 (svg-core)</h2>
                    <h2 class="subtitle"><font-awesome-icon icon="check" /> Configured as a (PWA) Progressive Web App</h2>
                    <h2 class="subtitle"><font-awesome-icon icon="check" /> Meta tags dynamically handled per route using <code>vue-meta</code></h2>
                    <h2 class="subtitle"><font-awesome-icon icon="check" /> Google Analytics ready to go and easily configurable using <code>vue-analytics</code></h2>
                    <h2 class="subtitle blog-intro"><font-awesome-icon icon="check" /> Configured to serve prerendered html using <code>prerender-spa-plugin</code></h2>
                </div>
            </div>
        </section>
